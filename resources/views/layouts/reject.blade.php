<!DOCTYPE html>
  <html lang="en">
    <head>
      ...
      <title>Kejari Kota Kediri</title>
    ...
    <div class="empty-2-1 container mx-auto d-flex align-items-center justify-content-center flex-column" style="font-family: 'Poppins', sans-serif;">    
        ...
        <div class="text-center w-100">
            ...
            <p class="title-caption">
                Halaman yang Anda cari Tidak Ada. Kita<br class="d-sm-block d-none"> sarankan untuk kembali ke halaman sebelumnya.
            </p>
            <div class="d-flex justify-content-center">
                <button class="btn btn-back d-inline-flex text-white" onclick="goBack()">
                    Kembali
                </button>
            </div>
        </div>
